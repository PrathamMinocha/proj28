...
var ground,tree,boy,stone,launcherObj;
...
launcherObj.display();
  ...
  DetCollision(stone,mango1);
  DetCollision(stone,mango2);
  DetCollision(stone,mango3);
  DetCollision(stone,mango4);
  DetCollision(stone,mango5);
  DetCollision(stone,mango6);
  DetCollision(stone,mango7);
  DetCollision(stone,mango8);
  DetCollision(stone,mango9);
...
function DetCollision(stone,mango){
